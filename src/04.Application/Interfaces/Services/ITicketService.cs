...
namespace SupportTicketSystem.Application.Abstractions.Services
{
    public interface ITicketService
    {
        ...
        Task<PagedResult<TicketDto>> GetTicketListAsync(string? status, Guid? assignedTo, PagedRequest request, string? priority, string? category, string? search, Guid? scopedToUserId = null);
